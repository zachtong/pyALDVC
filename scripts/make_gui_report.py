...
def main(argv=None) -> int:
    ...
    with PdfPages(str(out)) as pdf:
        ...
        lines = [
            ...
            "",
            "Standalone PySide6 window: volume list, parameter form (with memory estimate and VOI),",
            "run controls with progress and log, three-plane slice viewer with result overlays,",
            "result summary and exports (npz, mat, csv, vti, PDF). Sessions (.aldvc) store volumes,",
            "masks, parameters, output folder and display state. Languages: English, 简体中文.",
            "",
