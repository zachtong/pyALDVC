...
The material that used to fill the README: the algorithm, the Python API, every parameter,
the accuracy and throughput figures and the comparison with the MATLAB code. The user
guide for the application is [`user_guide.md`](user_guide.md); the conventions and design
